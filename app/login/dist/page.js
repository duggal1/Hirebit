...
var LoginPage = function () {
    return (react_1["default"].createElement("div", { className: "min-h-screen w-screen flex items-center justify-center bg-gray-900" },
        react_1["default"].createElement("div", { className: "flex w-full max-w-sm flex-col gap-6" },
            react_1["default"].createElement(link_1["default"], { href: "/", className: "flex flex-col items-center gap-2 self-center" },
                ...
                react_1["default"].createElement("div", { className: "text-6xl text-white font-black" },
                    "Hire",
