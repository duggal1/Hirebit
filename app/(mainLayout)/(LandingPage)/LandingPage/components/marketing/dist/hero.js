    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: "flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative" },
            ...
            React.createElement(container_1["default"], { delay: 0.3 },
                React.createElement("div", { className: "relative mx-auto max-w-7xl rounded-xl lg:rounded-[32px] border border-neutral-200/10 p-2 backdrop-blur-xl bg-transparent md:p-4 mt-12 shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500" },
