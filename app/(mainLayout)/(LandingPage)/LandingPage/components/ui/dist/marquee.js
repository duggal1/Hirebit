...
function Marquee(_a) {
    ...
    return (React.createElement("div", __assign({}, props, { className: functions_1.cn("group flex overflow-hidden p-2 [--duration:40s] [--gap:1rem] [gap:var(--gap)]", {
            "flex-row": !vertical,
            "flex-col": vertical
        }, className) }), Array(repeat)
        .fill(0)
        .map(function (_, i) { return (React.createElement("div", { key: i, className: functions_1.cn("flex shrink-0 justify-around [gap:var(--gap)]", {
