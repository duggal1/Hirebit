...
var Progress = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ProgressPrimitive.Root, __assign({ ref: ref, className: functions_1.cn("relative h-4 w-full overflow-hidden rounded-full bg-secondary", className) }, props),
