...
var DropdownMenuSubTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(DropdownMenuPrimitive.SubTrigger, __assign({ ref: ref, className: functions_1.cn("flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent", inset && "pl-8", className) }, props),
        children,
...
var DropdownMenuSubContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(DropdownMenuPrimitive.SubContent, __assign({ ref: ref, className: functions_1.cn("z-50 min-w-[8rem] overflow-hidden rounded-lg border bg-popover p-1 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2", className) }, props)));
});
...
var DropdownMenuRadioItem = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(DropdownMenuPrimitive.RadioItem, __assign({ ref: ref, className: functions_1.cn("relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className) }, props),
        React.createElement("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center" },
            React.createElement(DropdownMenuPrimitive.ItemIndicator, null,
...
var DropdownMenuLabel = React.forwardRef(function (_a, ref) {
    var className = _a.className, inset = _a.inset, props = __rest(_a, ["className", "inset"]);
    return (React.createElement(DropdownMenuPrimitive.Label, __assign({ ref: ref, className: functions_1.cn("px-2 py-1.5 text-sm font-semibold", inset && "pl-8", className) }, props)));
});
exports.DropdownMenuLabel = DropdownMenuLabel;
DropdownMenuLabel.displayName = DropdownMenuPrimitive.Label.displayName;
var DropdownMenuSeparator = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(DropdownMenuPrimitive.Separator, __assign({ ref: ref, className: functions_1.cn("-mx-1 my-1 h-px bg-muted", className) }, props)));
});
exports.DropdownMenuSeparator = DropdownMenuSeparator;
DropdownMenuSeparator.displayName = DropdownMenuPrimitive.Separator.displayName;
var DropdownMenuShortcut = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("span", __assign({ className: functions_1.cn("ml-auto text-xs tracking-widest opacity-60", className) }, props)));
};
