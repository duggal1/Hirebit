...
var DialogOverlay = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(DialogPrimitive.Overlay, __assign({ ref: ref, className: functions_1.cn("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className) }, props)));
});
...
var DialogHeader = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ className: functions_1.cn("flex flex-col space-y-1.5 text-center sm:text-left", className) }, props)));
};
...
var DialogTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(DialogPrimitive.Title, __assign({ ref: ref, className: functions_1.cn("text-lg font-semibold leading-none tracking-tight", className) }, props)));
});
exports.DialogTitle = DialogTitle;
DialogTitle.displayName = DialogPrimitive.Title.displayName;
var DialogDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(DialogPrimitive.Description, __assign({ ref: ref, className: functions_1.cn("text-sm text-muted-foreground", className) }, props)));
});
