...
var FormItem = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(FormItemContext.Provider, { value: { id: id } },
        React.createElement("div", __assign({ ref: ref, className: functions_1.cn("space-y-1 w-full", className) }, props))));
});
...
var FormLabel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(label_1.Label, __assign({ ref: ref, className: functions_1.cn(error && "text-destructive", className), htmlFor: formItemId }, props)));
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formDescriptionId, className: functions_1.cn("text-sm text-muted-foreground", className) }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formMessageId, className: functions_1.cn("text-sm text-destructive", className) }, props), body));
});
