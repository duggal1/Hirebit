...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/src/app/(mainLayout)/(LandingPage)/LandingPage/components/ui/accordion";
import { cn } from "@/src/app/(mainLayout)/(LandingPage)/LandingPage/functions";
import { useClickOutside } from "@/src/app/(mainLayout)/(LandingPage)/LandingPage/hooks";
