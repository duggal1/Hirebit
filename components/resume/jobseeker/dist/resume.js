...
function JobSeekerResume(_a) {
    ...
    return (React.createElement("div", { className: "relative min-h-screen bg-black overflow-hidden" },
        React.createElement("div", { className: "absolute inset-0 pointer-events-none" },
            React.createElement("div", { className: "" }),
            React.createElement("div", { className: "" })),
        React.createElement("div", { className: "relative mx-auto px-6 py-12 max-w-7xl z-10" },
            React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, className: "space-y-10" },
                React.createElement(framer_motion_1.motion.header, { initial: { y: -50, opacity: 0 }, animate: { y: 0, opacity: 1 }, className: "relative mb-16" },
                    React.createElement("div", { className: "absolute -top-20 -left-20 w-60 h-60 bg-blue-700/20 rounded-full blur-3xl" }),
                    React.createElement("div", { className: "relative flex items-center gap-8" },
                        React.createElement(framer_motion_1.motion.div, { initial: { scale: 0 }, animate: { scale: 1 }, className: "bg-gradient-to-br from-blue-800/30 to-purple-800/30 p-6 rounded-xl backdrop-blur-lg border border-gray-700" },
                            React.createElement(lucide_react_1.Rocket, { className: "w-10 h-10 text-blue-300" })),
                        React.createElement("div", null,
                            ...
                            React.createElement(framer_motion_1.motion.p, { initial: { x: -20, opacity: 0 }, animate: { x: 0, opacity: 1 }, transition: { delay: 0.2 }, className: "mt-3 text-xl text-gray-300" }, "Let's enhance your professional profile")))),
                React.createElement(form_1.Form, __assign({}, form),
                    React.createElement("form", { onSubmit: onSubmit, className: "space-y-8" },
                        React.createElement(framer_motion_1.motion.div, { initial: { y: 20, opacity: 0 }, animate: { y: 0, opacity: 1 }, className: "grid grid-cols-1 lg:grid-cols-2 gap-8" },
                            React.createElement("div", { className: "bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg" },
                                React.createElement(form_1.FormField, { control: form.control, name: "resumeName", render: function (_a) {
                                        ...
                                        return (React.createElement(form_1.FormItem, { className: "mb-8" },
                                            ...
                                            React.createElement(form_1.FormControl, null,
                                                React.createElement(input_1.Input, __assign({}, field, { className: "h-14 bg-black border border-gray-700 focus:border-blue-400 rounded-xl text-white placeholder-gray-500", placeholder: "Enter a name for your resume" }))),
                                ...
                                React.createElement(form_1.FormField, { control: form.control, name: "resumeBio", render: function (_a) {
                                        ...
                                        return (React.createElement(form_1.FormItem, null,
                                            ...
                                            React.createElement(form_1.FormControl, null,
                                                React.createElement(textarea_1.Textarea, __assign({}, field, { className: "min-h-[150px] bg-black border border-gray-700 focus:border-blue-400 rounded-xl text-white placeholder-gray-500", placeholder: "Write a compelling professional bio" }))),
                                            React.createElement(form_1.FormMessage, null)));
                                    } })),
                            React.createElement("div", { className: "relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 to-black p-1 shadow-lg" },
                                ...
                                React.createElement("div", { className: "relative bg-gray-900/80 backdrop-blur-xl rounded-xl p-8 border border-gray-700" },
                                    React.createElement("div", { className: "space-y-8" },
                                        React.createElement("div", { className: "space-y-2" },
                                            React.createElement("div", { className: "inline-flex items-center px-3 py-1 rounded-full bg-violet-800/10 border border-violet-800/20" },
                                            ...
                                            React.createElement("p", { className: "text-gray-400 text-sm leading-relaxed max-w-md" }, "Design a professional resume that captures attention and showcases your potential.")),
                                        React.createElement("div", { className: "grid grid-cols-2 gap-4" },
                                            React.createElement("div", { className: "p-4 rounded-xl bg-black/30 border border-gray-700" },
                                                React.createElement("div", { className: "text-sm font-medium text-white" }, "AI-Powered"),
                                                React.createElement("div", { className: "text-xs text-gray-400 mt-1" }, "Smart formatting & suggestions")),
                                            React.createElement("div", { className: "p-4 rounded-xl bg-black/30 border border-gray-700" },
                                                React.createElement("div", { className: "text-sm font-medium text-white" }, "ATS-Friendly"),
                                                React.createElement("div", { className: "text-xs text-gray-400 mt-1" }, "Optimized for job systems"))),
                                        React.createElement("a", { href: "/resume/" + jobSeekerId + "/resume-builder", className: "group relative flex items-center justify-between w-full" },
                                            React.createElement("div", { className: "absolute inset-0 bg-gradient-to-r from-violet-700 to-cyan-700 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" }),
                                            React.createElement("div", { className: "relative flex items-center justify-between w-full px-6 py-4 rounded-2xl bg-black/40 border border-gray-700 group-hover:border-gray-500 transition-all duration-300" },
                                    ...
                                    React.createElement("div", { className: "absolute bottom-8 right-8 flex items-center gap-2" },
                                        ...
                                        React.createElement("span", { className: "text-xs text-gray-500 font-medium" }, "System Online")))),
                            React.createElement("div", { className: "bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg" },
                                React.createElement("div", { className: "flex items-center gap-4 mb-8" },
                                    React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.1 }, className: "bg-gradient-to-r from-blue-800/20 to-purple-800/20 p-3 rounded-lg" },
                                        React.createElement(lucide_react_1.UploadCloud, { className: "w-6 h-6 text-blue-300" })),
                                        ...
                                        return (React.createElement(form_1.FormItem, null,
                                            React.createElement(form_1.FormControl, null,
                                                React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.02 }, transition: { type: "spring", stiffness: 300 } },
                                                    React.createElement(FileUpload_1.FileUpload, { value: field.value, onChange: handleResumeUpload, disabled: analyzing, className: "border-2 border-dashed border-gray-700 hover:border-blue-400 rounded-2xl transition-all duration-300" },
                                                        React.createElement("div", { className: "flex flex-col items-center justify-center h-56 space-y-6" },
                                                            React.createElement(framer_motion_1.motion.div, { animate: { y: [0, -10, 0] }, transition: { repeat: Infinity, duration: 2 }, className: "bg-gradient-to-r from-blue-800/20 to-purple-800/20 p-5 rounded-full" },
                                                                React.createElement(lucide_react_1.UploadCloud, { className: "w-10 h-10 text-blue-300" })),
                                ...
                                analyzing && (React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, className: "mt-6" },
                                    React.createElement("div", { className: "bg-blue-700/10 rounded-xl p-4 border border-blue-700/20" },
                                        React.createElement("div", { className: "flex items-center gap-3 mb-3" },
                                            React.createElement(lucide_react_1.Loader2, { className: "w-5 h-5 text-blue-300 animate-spin" }),
                                            React.createElement("p", { className: "text-blue-300 font-medium" }, "Analyzing your resume...")),
                                        React.createElement(progress_1.Progress, { value: 66, className: "h-1 bg-gray-700", indicatorClassName: "bg-gradient-to-r from-purple-400 via-pink-500 to-red-500" })))))),
                        React.createElement(framer_motion_1.AnimatePresence, null, resumeAnalysis && (React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -20 }, className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" },
                            React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.02 }, className: "col-span-full bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg" },
                                ...
                                React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6" },
                                    React.createElement("div", { className: "bg-black/30 rounded-xl p-6 border border-gray-700" },
                                        React.createElement("div", { className: "flex items-center gap-3 mb-4" },
                                            React.createElement(lucide_react_1.Briefcase, { className: "w-5 h-5 text-blue-300" }),
                                    ...
                                    React.createElement("div", { className: "bg-black/30 rounded-xl p-6 border border-gray-700" },
                                        React.createElement("div", { className: "flex items-center gap-3 mb-4" },
                                            React.createElement(lucide_react_1.Zap, { className: "w-5 h-5 text-purple-300" }),
                            ...
                            React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.02 }, className: "bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg" },
                            ...
                            React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.02 }, className: "bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg" },
                                ...
                                React.createElement("div", { className: "space-y-6" },
                                    React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: "bg-green-800/10 rounded-xl p-4 border border-green-800/20" },
                                    ...
                                    React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: "bg-yellow-800/10 rounded-xl p-4 border border-yellow-800/20" },
                            ...
                            React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.02 }, className: "bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg" },
                                ...
                                React.createElement("div", { className: "space-y-4" },
                                    ...
                                    resumeAnalysis.buzzwords.list.length > 0 && (React.createElement("div", { className: "flex flex-wrap gap-2 mt-4" }, resumeAnalysis.buzzwords.list.map(function (word, index) { return (React.createElement(framer_motion_1.motion.span, { key: index, initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 }, transition: { delay: index * 0.1 }, className: "px-3 py-1 bg-purple-800/10 text-purple-300 rounded-full text-sm" }, word)); }))),
                                    resumeAnalysis.buzzwords.warning && (React.createElement(framer_motion_1.motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, className: "mt-4 p-4 bg-red-800/10 rounded-xl border border-red-800/20" },
                                    ...
                                    resumeAnalysis.additionalRecommendations && (React.createElement(framer_motion_1.motion.div, { whileHover: { scale: 1.03, boxShadow: "0 0 30px rgba(255,255,255,0.1)" }, whileTap: { scale: 0.98 }, initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { type: "spring", stiffness: 300 }, className: "relative bg-black/30 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 shadow-lg overflow-hidden" },
                                        React.createElement("div", { className: "absolute inset-0 bg-gradient-to-br from-blue-800/10 via-purple-800/10 to-pink-800/10 pointer-events-none blur-3xl" }),
                                        React.createElement("div", { className: "relative" },
                        ...
                        React.createElement(framer_motion_1.motion.button, { type: "submit", disabled: !isFormValid, initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, className: utils_1.cn("w-full h-14 bg-gradient-to-r from-indigo-600 to-pink-600 text-white rounded-lg font-semibold transition transform duration-200 ease-in-out", !isFormValid && "opacity-50 cursor-not-allowed") },
